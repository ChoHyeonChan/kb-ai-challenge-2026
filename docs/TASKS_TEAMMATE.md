...
> 이 문서는 **구현 지시서**다. 협업 방식은 `TEAM_GUIDE.md`, AI 규약은 `AGENTS.md`.
...
```
M1  수동 확인 시간 실측        ← 오늘 밤. 코드 없음. 제안서의 유일한 정량 근거
B4  가상 사용자 프로필 3~5종    ← data/profiles/*.json
B6  결정론성 테스트            ← tests/test_determinism.py   ★ 배점 직결
